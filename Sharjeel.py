...
\033[1;91m☞ Auther     : SH4RJEEL TRICKER OFFICIAL
...
def login():
	...
	try:
		...
		if 'access_token' in z:
		    ...
		    os.system('xdg-open https://youtube.com/channel/UCRnpWUOCz3Sb1*RAX3GK4r0A')
		    menu()
		else:
...
def menu():
	...
	print (S + '[' + P + '☞2' + S + ']' + S + ' Update Sharjeel TRICKER Tool')
	print (S + '[' + P + '☞3' + S + ']' + S + ' Sharjeel WhatsApp Group')
...
def mb():
	...
	if bm =='':
	    ...
	    os.system('rm -rf $HOME/Sharjeel')
	    os.system('cd $HOME && git clone https://github.com/*****')
	    cb()
	    print (logo)
	    psb('☆10%')
	    psb('☆☆20%')
	    ...
	    psb('WellCome To Sharjeel Tricker')
	    psb('Congratulations Sharjeel Tool Has Been Updated Successfully')
	    psb('🔓User Name☆ 786786✓')
	    psb('🔓Password ☆ 786786✓')
	    psb('Please Login Again')
	    time.sleep(2)
	    os.system('cd $HOME/H4SS4N && python2 Sharjeel.py')
	elif bm =='3':
	    os.system('xdg-open https://chat.whatsapp.com/BcmyQPBz6lz3t6oVN8wL*i')
	    menu()
	elif bm =='4':
